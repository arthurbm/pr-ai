...
List of suggestions to improve the `pr-ally` CLI, based on previous recommendations.
...
- [x] **Configuration File:** Allow a file (`.pr-ally.json`?) to define defaults.
...
- [ ] **Test Installation:** Install globally (`npm install -g pr-ally`) and test. 